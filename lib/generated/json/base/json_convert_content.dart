...
class JsonConvert {
	static final Map<String, JsonConvertFunction> _convertFuncMap = {
		...
		(ProductListProductList).toString(): ProductListProductList.fromJson,
	};
  ...
  T? asT<T extends Object?>(dynamic value) {
	...
	static M? _getListChildType<M>(List<Map<String, dynamic>> data) {
		...
		if(<ProductListProductList>[] is M){
			return data.map<ProductListProductList>((Map<String, dynamic> e) => ProductListProductList.fromJson(e)).toList() as M;
		}
